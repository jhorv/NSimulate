namespace NSimulate.Instruction
{
    ...
    public abstract class InstructionBase
    {
        ...
        /// </summary>
        public long RaisedInTimePeriod { get; set; }
        ...
        /// </summary>
        public bool IsCompleted => CompletedAtTimePeriod != null;
        ...
        /// </value>
        public long? CompletedAtTimePeriod { get; protected set; }

        public virtual Priority Priority { get; protected set; }
        ...
        /// Context providing state information for the current simulation.
        /// </param>
        public virtual void Complete(SimulationContext context) => CompletedAtTimePeriod = context.TimePeriod;
        ...
        /// Context providing state information for the current simulation.
        /// </param>
        public virtual void Interrupt(SimulationContext context) => IsInterrupted = true;
    }
}
