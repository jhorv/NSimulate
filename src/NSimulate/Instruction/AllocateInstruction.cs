...
namespace NSimulate.Instruction
{
        ...
        where TResource : Resource
    {
        ...
        /// </summary>
        readonly Func<TResource, bool> _resourceMatchFunction = (o) => true;

        /// <summary>
        /// A function used to determine a priority of a resource, used to prioritise resource selections
        /// </summary>
        readonly Func<TResource, int> _resourcePriorityFunction;

        /// <summary>
        /// Gets the set of allocations made whe completing this instruction
        /// </summary>
        public List<KeyValuePair<TResource, int>> Allocations { get; private set; }

        /// <summary>
        /// Gets the number of resources requested.
        /// </summary>
        public int NumberRequested { get; private set; }
        ...
        public void Release()
        {
            ...
            {
                foreach (KeyValuePair<TResource, int> allocation in Allocations)
                {
