...
namespace NSimulate.Instruction
{
    ...
    {
        readonly List<InstructionBase> _instructions;
        ...
        public override bool CanComplete(SimulationContext context, out long? skipFurtherChecksUntilTimePeriod)
        {
            ...
            var nullCheckTimePeriodEncountered = false;
            ...
            {
                var thisInstructionCanComplete = instruction.CanComplete(context, out var nextCheckTimePeriod);
