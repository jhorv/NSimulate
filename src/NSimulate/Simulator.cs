...
namespace NSimulate
{
    ...
    public class Simulator
    {
        ...
        protected SimulationContext Context { get; set; }
        ...
        public void Simulate()
        {
            ...
            while (!complete)
            {
                ...
                {
                    Process process = Context.ProcessesRemainingThisTimePeriod.Dequeue();
        ...
        private void SimulateProcessAtTimePeriod(Process process, ref long? nextTimePeriod)
        {
            ...
            while (shouldMoveNext && !Context.IsSimulationTerminating)
            {
                ...
                if (shouldMoveNext)
                {
                    var couldMoveNext = process.SimulationState.InstructionEnumerator.MoveNext();
                    if (couldMoveNext)
                    {
